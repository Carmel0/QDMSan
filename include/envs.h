...
static char *afl_environment_variables[] = {
    ...
    /* Keep retired DMSAN names in the allowlist so afl-fuzz can emit
       explicit migration errors instead of reporting them as unknown typos. */
    "AFL_DMSAN_MODE", "AFL_DMSAN_DEPLOY",
    "AFL_DMSAN_AUX_FEEDBACK", "AFL_DMSAN_AUX_CACHE", "AFL_DMSAN_AUX_NONDET",
    "AFL_DMSAN_CAL_REUSE",
    "AFL_DMSAN_RUN3_DEDUP", "AFL_DMSAN_CONFIRM_RUNS",
    "AFL_DMSAN_CLEAN_CACHE", "AFL_DMSAN_DEBUG",
    "AFL_DMSAN_SAVE_NONDET", "AFL_DMSAN_DUMP_SIG",
    "AFL_DMSAN_REPLAY_FILE",
    "AFL_DMSAN_REPLAY_FIXED_TIME_SEC",
    "AFL_DMSAN_REPLAY_FIXED_TIME_USEC",
    "AFL_DMSAN_REPLAY_FIXED_RAND_BASE",
    "AFL_DMSAN_REPLAY_FIXED_TSC_BASE",
    "AFL_DMSAN_REPLAY_FIXED_RDRAND_BASE",
    "AFL_USE_DMSAN", "AFL_USE_DMSAN_FULL", "AFL_USE_DMSAN_INLINE",
    "AFL_DMSAN_SITECLASS", "AFL_DMSAN_EXEC",
    "AFL_DMSAN_L2", "AFL_DMSAN_FEEDBACK",
    "AFL_QDMSAN_MODE", "AFL_QDMSAN_DEPLOY", "AFL_QDMSAN_CHECK",
    "AFL_QDMSAN_PAPER_COMPAT",
    "AFL_QDMSAN_STACK_MAX",
    "AFL_QDMSAN_STACK", "AFL_QDMSAN_CHECK_POINTERS",
    "AFL_QDMSAN_CHECK_SYSCALLS", "AFL_QDMSAN_CHECK_BRANCHES",
    "AFL_QDMSAN_CMP_BRANCH_PRUNE", "AFL_QDMSAN_COMPAT_STUBS",
    "AFL_QDMSAN_FULL_SIZE", "AFL_QDMSAN_HEAP_PLANES",
    "AFL_QDMSAN_QUARANTINE_MB", "AFL_USE_QDMSAN",
